    ...
    "paths": {
        ...
        "/book/by-author/{author_id}": {
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Некорректный ID автора или параметр отсутствует",
                        "schema": {
                            "type": "object",
                    ...
                    "404": {
                        "description": "Книги не найдены для указанного автора",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/book/search": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Успешный ответ с книгами",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/book/upload": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "Файл книги (PDF, EPUB, etc.)",
                        "name": "File",
                        "in": "formData"
                    }
                ],
        ...
        "/chat/private/conversation/{user_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dto.PrivateMessageResponse"
                            }
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.PrivateMessageRequest"
                        }
                    }
                ],
                "responses": {
